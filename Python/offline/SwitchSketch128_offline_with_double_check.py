    ...
    for _K in [64, 128, 256, 512, 1024]:
        ...
        for _memorysize in temp_memo:
            ...
            for key in set_HH:
                ...
                ID2 = mmh3.hash(key, SEED[2]) % BUCKET_NUM
                ...
                query_result2 = Query(key, ID2,FP_l1,FP_l2,FP_l3)
                ...
                value_result = min(value1,value2)
                if value1 != 0 or value2 != 0:
                    C = 1.0 - (min(value1, value2) / max(value1, value2))
                    if C < k:
